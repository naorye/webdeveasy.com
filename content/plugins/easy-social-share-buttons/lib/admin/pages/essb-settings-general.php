			...
			<div class="essb-options-container" style="min-height: 550px;">
				...
				<div id="essb-container-7" class="essb-data-container">
					...
					<table border="0" cellpadding="5" cellspacing="0" width="100%">
						...
						<tr class="even table-border-bottom">
							<td class="bold" valign="top">Force share of post/page address with query parameters:<br/><span class="label" style="font-weight: 400;">Activate this option if you use query string parameters with your url and what plugin to share full url with them (not only permalink).</span></td>
...
<tr class="even table-border-bottom">
							...
							<td><input type="text" class="input-element stretched" name="social[rss][feedblitz]"
								class="code" id="social[rss][feedblitz]"
				...
				<div id="essb-container-11" class="essb-data-container">
					...
					<table border="0" cellpadding="5" cellspacing="0" width="100%">
						...
						<tr class="even table-border-bottom">
							...
							ESSB_Settings_Helper::drawSelectField('esml_ttl', $data_refresh); ?></td>
						</tr>
						<tr class="odd table-border-bottom">
							<td class="bold" valign="top">Choose update provider:<br/><span class="label">Choose default metrics update provider. You can use sharedcount.com where all data is extracted with single call. According to high load of sharedcount you can use the another update method with native calls from your WordPress instance.</span></td>
							<td>
							<?php 
