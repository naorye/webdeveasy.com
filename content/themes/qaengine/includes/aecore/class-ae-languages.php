...
class AE_Language extends AE_Base {
	...
	*/
	function __construct () {
		...
		/* http://stackoverflow.com/questions/6195451/how-to-get-wp-include-directory */
		//$this->_wp_include_dir 	= preg_replace('/wp-content$/', 'wp-includes', WP_CONTENT_DIR);
		$this->_wp_include_dir 	= ABSPATH . WPINC;//preg_replace('/wp-content$/', 'wp-includes', WP_CONTENT_DIR);
