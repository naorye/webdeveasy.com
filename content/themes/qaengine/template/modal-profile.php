    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="submit_edit_profile" class="form_modal_style edit_profile_form">
            ...
            <input type="text" class="submit-input" id="display_name" name="display_name" value="<?php echo $display_name; ?>">

            <label><?php _e("Location", ET_DOMAIN) ?></label>
            <input type="text" class="submit-input" id="user_location" name="user_location" value="<?php echo $user_location; ?>">

            <label><?php _e("Facebook", ET_DOMAIN) ?></label>
            <input type="text" class="submit-input" id="user_facebook" name="user_facebook" value="<?php echo $facebook; ?>">

            <label><?php _e("Twitter", ET_DOMAIN) ?></label>
            <input type="text" class="submit-input" id="user_twitter" name="user_twitter" value="<?php echo $twitter; ?>">

            <label><?php _e("Google+", ET_DOMAIN) ?></label>
            <input type="text" class="submit-input" id="user_gplus" name="user_gplus" value="<?php echo $google; ?>">
            ...
            <textarea class="submit-textarea" id="description" name="description"><?php echo $description; ?></textarea>
